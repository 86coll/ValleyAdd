...
export let roomsJson = JSON.parse(FileLib.read("Valley Addons", "components/rooms.json"))
...
export const getRoomsFile = () => JSON.parse(FileLib.read("smarterzpew", "utils/rooms.json"))
